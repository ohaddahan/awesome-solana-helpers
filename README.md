...
* [pinocchio - Create Solana programs with no dependencies attached](https://github.com/febo/pinocchio)
* [mucho - a command-line tool designed to simplify the development and testing of Solana blockchain programs](https://github.com/solana-developers/mucho)
* [codama - Codama is a tool that describes any Solana program in a powerful standardised format known as the Codama IDL](https://github.com/codama-idl/codama)
